...
class somaOptions extends somaticFramework  {
	...
	*/
	...
	function add_pages() {
		...
		add_submenu_page( 'somatic-framework-options', 'Framework Options', 'Options', 'update_core', 'somatic-framework-options', 
			function() { somaOptions::soma_options_page("options"); } 
		);
		add_submenu_page( 'somatic-framework-options', 'Advanced', 'Advanced', 'update_core', 'somatic-framework-advanced', 
			function() { somaOptions::soma_options_page("advanced"); } 
		);
		add_submenu_page( 'somatic-framework-options', 'System Reports', 'Reports', 'update_core', 'somatic-framework-reports', 
			function() { somaOptions::soma_options_page("reports"); } 
		);
...
?>
	...
	function soma_help_validate( $input ) {
		// strip html
		array_walk( $input, function( &$v,$k ) { $v = wp_filter_nohtml_kses($v); } );
		return $input;
	}
